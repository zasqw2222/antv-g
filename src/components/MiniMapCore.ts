...
class MinimapCore extends mapboxgl.NavigationControl {
  ...
  private addToggleButton(): void {
    this.toggleDisplayButton = this.options.toggleDisplay
      ? this.createButton(
          ...
          'minimap mapbox-ctrl-minimap-toggle-display mapbox-ctrl-minimap-toggle-display-' +
            this.options.togglePosition,
          this.container,
          this.toggle,
          this
        )
  ...
  private minimize(): void {
    if (this.options.toggleDisplay) {
      ...
      this.toggleDisplayButton.className +=
        ' minimized-' + this.options.togglePosition;
  ...
  private restore(): void {
    if (this.options.toggleDisplay) {
      ...
      this.toggleDisplayButton.className =
        this.toggleDisplayButton.className.replace(
          'minimized-' + this.options.togglePosition,
          ''
        );
  ...
  private adjustZoom(): void {
    this.miniMap.setZoom(
      this.parentMap.getZoom() + this.options.zoomLevelOffset
    );
  }
